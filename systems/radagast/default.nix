...

{
  imports = [
    ...
    flake.inputs.nixos-hardware.nixosModules.apple-macbook-pro-14-1
    flake.inputs.self.nixosModules.atlas
  ];

  nixos-flake.sshTarget = "josh@radagast";
  ...
  users.users.josh = {
    ...
    openssh.authorizedKeys.keys = config.atlas.me.sshKeys;
  };
  ...
  # age.secrets.radagast-acme-env.file = "${inputs.self}/secrets/radagast-acme-env.age";
  ...
  #   uploadHttp = {
  #     domain = "upload.radagast.joshkingsley.me";
  #   };
  # };
